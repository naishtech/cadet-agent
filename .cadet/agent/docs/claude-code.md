...
3. Confirm these paths exist: `.cadet/agent/core/` and `.claude/skills/cadet-agent.md`.
...
## Updating
- Replace `.claude/skills/cadet-agent.md` and `.cadet/agent/core` from a new package version.
