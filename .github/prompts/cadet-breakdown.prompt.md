---
description: "Cadet Story Breakdown skill: decompose large work into epics and small implementable stories."
---

> This prompt inlines the canonical skill from `.cadet/agent/core/skills/StoryBreakdown.md`. Keep the two files in sync.
