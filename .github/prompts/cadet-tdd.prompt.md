---
description: "Cadet TDD skill: implement changes through red/green test-first cycles."
---

> This prompt inlines the canonical skill from `.cadet/agent/core/skills/TDD.md`. Keep the two files in sync.
