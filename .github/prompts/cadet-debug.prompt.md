---
description: "Cadet Debugging skill: reproduce, isolate, and fix defects with regression protection."
---

> This prompt inlines the canonical skill from `.cadet/agent/core/skills/Debugging.md`. Keep the two files in sync.
